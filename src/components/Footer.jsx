...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-white pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Empowering businesses with advanced workflow solutions to enhance productivity,
              streamline operations, and drive growth in an ever-changing digital landscape.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/beta" className="text-gray-400 hover:text-white transition">Beta Program</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/api" className="text-gray-400 hover:text-white transition">API Status</Link></li>
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Get the latest news and updates from SaaSPro, directly to your inbox.
            </p>
            <NewsletterSignup />
          </div>
        </div>
